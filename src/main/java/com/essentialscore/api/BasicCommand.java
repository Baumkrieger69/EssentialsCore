 ...
 */
public class BasicCommand implements CommandDefinition {
     ...
     */
    public BasicCommand(String name, String description, String usage, String permission, String moduleName) {
        this.name = name;
     ...
     */
    public BasicCommand setExecutor(BiFunction<CommandSender, String[], Boolean> executor) {
     ...
     * @return This command for method chaining
     */
    public BasicCommand setTabCompleter(BiFunction<CommandSender, String[], List<String>> tabCompleter) {
     ...
     * @return This command for method chaining
     */
    public BasicCommand addAlias(String alias) {
     ...
     * @return This command for method chaining
     */
    public BasicCommand addTabCompletionOptions(int argIndex, List<String> options) {
