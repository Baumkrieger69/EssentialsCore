...
public class PlaceholderIntegration extends AbstractPluginIntegration {
    ...
    private void registerDefaultPlaceholders() {
        // Player placeholders
        registerPlayerPlaceholder("player_name", (player, placeholder) -> player.getName());
        registerPlayerPlaceholder("player_displayname", (player, placeholder) -> player.getDisplayName());
        registerPlayerPlaceholder("player_uuid", (player, placeholder) -> player.getUniqueId().toString());
        registerPlayerPlaceholder("player_world", (player, placeholder) -> player.getWorld().getName());
        registerPlayerPlaceholder("player_health", (player, placeholder) -> String.valueOf(player.getHealth()));
        registerPlayerPlaceholder("player_max_health", (player, placeholder) -> String.valueOf(player.getMaxHealth()));
