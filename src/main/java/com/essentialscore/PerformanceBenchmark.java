...
public class PerformanceBenchmark {
     ...
     */    public Map<String, Object> benchmarkThreadPool() {
        ...
        // ThreadManager not available - using default values
        results.put("pool_size", "N/A - ThreadManager disabled");
        results.put("core_pool_size", "N/A - ThreadManager disabled");
        results.put("max_pool_size", "N/A - ThreadManager disabled");
          // Benchmark: Einfache Aufgaben (ThreadManager not available)
        results.put("simple_tasks_benchmark", "Disabled - ThreadManager not available");
        results.put("simple_tasks_completed", false);
        results.put("simple_tasks_duration_ms", 0);
        results.put("tasks_per_second", 0.0);
          // Benchmark: Komplexe CPU-lastige Aufgaben (ThreadManager not available)
        results.put("heavy_tasks_benchmark", "Disabled - ThreadManager not available");
        results.put("heavy_tasks_completed", false);
        results.put("heavy_tasks_duration_ms", 0);
        results.put("heavy_tasks_per_second", 0.0);
        
        // Thread-Pool-Auslastung nach dem Test (not available)
        results.put("active_threads_after", "N/A - ThreadManager disabled");
        results.put("completed_tasks", "N/A - ThreadManager disabled");
        results.put("queue_size", "N/A - ThreadManager disabled");
