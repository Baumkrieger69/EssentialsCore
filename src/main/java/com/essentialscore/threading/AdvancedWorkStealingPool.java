...
public class AdvancedWorkStealingPool extends ForkJoinPool {
    ...
    public AdvancedWorkStealingPool(
        ...
        super(parallelism);
        this.logger = logger;
        this.keepAliveMs = 0; // KeepAliveMs wird nicht verwendet
        ...
        Thread.setDefaultUncaughtExceptionHandler((t, e) -> {
            System.err.println("Uncaught exception in AdvancedWorkStealingPool: " + e.getMessage());
            e.printStackTrace();
        });
    ...
    public <T> T invokeAny(Collection<? extends Callable<T>> tasks, 
        ...
        throw ee[0] != null ? ee[0] : new ExecutionException(new CancellationException());
    }
     ...
     */
    private static class MinecraftFriendlyForkJoinWorkerThreadFactory implements ForkJoinWorkerThreadFactory {
